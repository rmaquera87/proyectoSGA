...
public class ClienteController extends HttpServlet {
    ...
    protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (metodo==null) {
          clienteService.lista(request, response);
        }else if (metodo.equals("registra")) {
            clienteService.registra(request, response);
        }else if (metodo.equals("lista")) {
            clienteService.lista(request, response);
        }else if (metodo.equals("actualiza")) {
            clienteService.actualiza(request, response);
        }else if (metodo.equals("busca")) {
            clienteService.busca(request, response);
        }else if (metodo.equals("elimina")) {
            clienteService.elimina(request, response);
        }else if (metodo.equals("ubica")) {
            clienteService.ubica(request, response);
        }
