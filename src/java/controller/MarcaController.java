...
public class MarcaController extends HttpServlet {
    ...
    protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (metodo==null) {
          marcaService.lista(request, response);
        }else if (metodo.equals("registra")) {
            marcaService.registra(request, response);
        }else if (metodo.equals("lista")) {
            marcaService.lista(request, response);
        }else if (metodo.equals("actualiza")) {
            marcaService.actualiza(request, response);
        }else if (metodo.equals("busca")) {
            marcaService.busca(request, response);
        }else if (metodo.equals("elimina")) {
            marcaService.elimina(request, response);
        }else if (metodo.equals("ubica")) {
            marcaService.ubica(request, response); 
        }
