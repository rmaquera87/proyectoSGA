 ...
 * @author MELANY
 */
public class ParteIngresoService {
    ...
    public void index(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        ViewResolve.showMain("parteIngreso/index.jsp", request, response);
    }
    ...
    public void load(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        ViewResolve.show("parteIngreso/MParteIngreso.jsp", request, response);
    }
    ...
    public void registra(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            int proveedor = (request.getParameter("cboProveedor") != null) ? Integer.parseInt(request.getParameter("cboProveedor")) : null;
            ...
            Logger.getLogger(ParteIngresoService.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public void lista(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            int proveedor = (request.getParameter("cboBusProveedor") != null) ? Integer.parseInt(request.getParameter("cboBusProveedor")) : null;
            String strFecha = "";
            if (!fecha.equals("")) {
                SimpleDateFormat strDate = new SimpleDateFormat("dd/MM/yyyy");
                Date dateFecha = strDate.parse(fecha);
            ...
            kcDTO.setIdProveedor(proveedor);
            kcDTO.setIdTdo(3);
            ...
            //request.getRequestDispatcher("/view/producto/listaProducto.jsp").forward(request, response);
            ViewResolve.show("parteIngreso/listaParteIngreso.jsp", request, response);
        } catch (ParseException ex) {
            Logger.getLogger(ParteIngresoService.class.getName()).log(Level.SEVERE, null, ex);
        }
