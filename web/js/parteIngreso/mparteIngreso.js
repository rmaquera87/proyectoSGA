...
$(document).ready(function () {
    ...
    function loadListaParteDetalle() {
        ...
        /*$.ajax({
         ...
         var dataProd = {"id": "", "idprod": obj.idProducto, "prod": obj.prdDescripcion, "cant": obj.kadCantidad};
         lstProd.push(dataProd);
    ...
    $("#btnGuardarParteIng").on("click", function (e) {
        ...
        if ($("#cboProveedor").val() == null || $("#cboProveedor").val() == 0) {

            $("#modal-alert-mensaje").html("Debe seleccionar un proveedor");
            $("#modal-alert").modal('show');
            return;
        }
