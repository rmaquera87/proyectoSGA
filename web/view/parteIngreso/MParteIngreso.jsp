...
<script src="js/parteIngreso/mparteIngreso.js"></script>
<!-- form start -->
...
<form id="frmParteIng" class="form-horizontal">
    ...
    <div class="box-body">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-4">
                <select class="form-control select2" id="cboProveedor" name="cboProveedor" style="width:100%">
                    <option value="0">--Seleccione--</option>
                    <%
                        List<Proveedor> dataProveedor = (List<Proveedor>) request.getAttribute("lsProveedor");
                        if (dataProveedor != null) {
                            for (Proveedor p : dataProveedor) {

                                if (dataParte != null && p.getIdProveedor() == dataParte.getIdProveedor()) {%>
                    <option value="<%=p.getIdProveedor()%>" selected><%=p.getRazonSocial()%></option>
                    <%} else {%>
        ...
        <div class="row">
            ...
            <div class="col-sm-2">    
                ...
                <jsp:include page="listaMParteIngreso.jsp"/>
    </div>
    <!-- /.box-body -->
