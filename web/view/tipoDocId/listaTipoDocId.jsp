<%-- 
    Document   : listaTipoDocId
    Created on : 21/07/2020, 11:24:18 PM
    Author     : CMENA
--%>
...
<html>
    <head>
        ...
        <title>Tipo Documento Identidad</title>
    </head>
    <body>
        <section class="content-header">
        <h1>
            Tipo Documento Identidad <button type="button" class="btn btn-primary btn-lg" data-toggle="modal" data-target="#myModal">Nuevo</button> <button type="button" class="btn btn-warning btn-lg" data-toggle="modal" data-target="#myModalSearch">Buscar</button>
        </h1>
        <ol class="breadcrumb">
 ...
 <section class="content">
    <div class="row">
        ...
        <table class="table table-bordered table-hover">
            ...
            <% 
                List<TipoDocId> data = (List<TipoDocId>)request.getAttribute("data");
                if (data!=null) {
                        for(TipoDocId x: data){
                        %>
                        <tr class="grilla_campo">
                            <td><%= x.getId_tipodoc()%></td>
                            <td><%= x.getTdi_descripcion()%></td>
                            <td><%= x.getTdi_abreviatura()%></td>

                            <td>
                                <a href="tipoDocId?metodo=elimina&id=<%= x.getId_tipodoc()%>">
                                    <img alt="Elimina" src="images/Delete.gif">
                                </a>
                            </td>
                            <td>
                                <a href="tipoDocId?metodo=busca&id=<%= x.getId_tipodoc()%>">
        ...
        <div class="modal-dialog">
          ...
          <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title">Insertar nuevo Tipo de Documento de Identidad</h4>
            </div>
